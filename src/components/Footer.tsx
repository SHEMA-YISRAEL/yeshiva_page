...
import logoFooter from "../../public/img/yeshivaLogoColor.png";
...
const SOCIAL_LINKS = [
  {
    icon: FaFacebookF,
    href: "https://www.facebook.com/profile.php?id=61572773797188&locale=es_LA",
    label: "Facebook",
  },
  {
    icon: FaInstagram,
    href: "https://www.instagram.com/yeshiva.cochabamba?utm_source=ig_web_button_share_sheet&igsh=MmppNWFyczRyN3Vn",
    label: "Instagram",
  },
  {
    icon: FaTiktok,
    href: "https://www.tiktok.com/@yeshiva.cochabamba?_t=ZM-8xdkhusjRGq&_r=1",
    label: "TikTok",
  },
...
const CONTACTS = [
  ...
  },
  {
    icon: FaEnvelope,
    label: "Email",
    value: "admisiones@yeshivaedu.com",
    href: "mailto:admisiones@yeshivaedu.com",
    isLink: true,
  },
  {
    icon: FaMapMarkerAlt,

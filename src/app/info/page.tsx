...
const contactInfo = {
  phone: "+591 76420527",
  email: "admisiones@yeshivaedu.com",
};
        ...
        >
          ...
          <div>
            <section data-aos="fade-up" data-aos-duration="1200">
              <div className="mb-5">
                <SectionTitle size={2} title="Contacto" />
              </div>
            ...
            <div className="mb-5">
              <SectionTitle size={2} title="Ubicación" />
            </div>
          ...
          <div data-aos="flip-left" data-aos-duration="900">
            <div className="relative w-full" style={{ paddingBottom: "75%" }}>
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d524.1311354462092!2d-66.20773421008533!3d-17.39291645822974!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1ses!2sbo!4v1753194106299!5m2!1ses!2sbo"

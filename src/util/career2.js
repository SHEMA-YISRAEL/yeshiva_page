...
const whyStudyThis = [
    ...
    "El Técnico en Laboratorio de Anatomía Patológica es un profesional capacitado para colaborar activamente en el estudio de tejidos, órganos y células humanas con el fin de apoyar el diagnóstico de enfermedades como el cáncer y otras alteraciones estructurales del organismo." 
...
const workArea = [
  ...
  {
    title: "Laboratorios privados de histopatología y citología",
    description:
      "Trabajan en equipos de paramédicos en ambulancias, respondiendo a emergencias médicas en el lugar del incidente y transportando a los pacientes a hospitales.",
  },

  {
    title: "Laboratorios forenses",
    description:
      "Trabajan en equipos de paramédicos en ambulancias, respondiendo a emergencias médicas en el lugar del incidente y transportando a los pacientes a hospitales.",
  },
